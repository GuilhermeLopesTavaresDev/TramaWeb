...
export default function Sidebar() {
    ...
    return (
        <aside className="sticky left-0 top-0 h-screen w-80 bg-white dark:bg-brand-dark/95 border-r border-zinc-100 dark:border-brand-blue/10 pt-8 pb-10 px-6 flex flex-col gap-10 overflow-hidden z-30 backdrop-blur-xl shrink-0">
