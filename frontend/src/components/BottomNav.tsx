...
export default function BottomNav() {
    ...
    return (
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-brand-dark/95 backdrop-blur-xl border-t border-zinc-100 dark:border-brand-blue/10 px-6 py-3 pb-safe z-[60] shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)]">
